...
//
#ifndef SNEEZE_GZIP_HPP
#define SNEEZE_GZIP_HPP
...
namespace sneeze::gzip_codec {
    //from https://github.com/chafey/GZipCodec
    //zlib用法见:https://www.cnblogs.com/wunaozai/p/3960494.html
