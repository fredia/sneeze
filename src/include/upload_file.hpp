...
#ifndef SNEEZE_UPLOAD_FILE_HPP
#define SNEEZE_UPLOAD_FILE_HPP
...
namespace sneeze {
    ...
    public:
        ...
        bool copy_to(const std::string &directory_path, const std::string &file_name = "") {
    ...
    private:
        void check_and_create_directory(const std::string &direcotry_path) {
            auto vec = split(std::string_view(direcotry_path.data(), direcotry_path.size()), "/");
